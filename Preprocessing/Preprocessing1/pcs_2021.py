...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  7 15:45:31 2021
...
#reading the question 1 for National Institute of Technology Warangal, IISc and Bharathiyar University
Q1_extra={'Institute':list(remaining),'Lifts/Ramps':['Yes, more than 80% of the buildings','Yes, more than 80% of the buildings','Yes, more than 80% of the buildings']}
...
df_Q1.to_csv('Outputs/pcs_2021.csv',index=False)
